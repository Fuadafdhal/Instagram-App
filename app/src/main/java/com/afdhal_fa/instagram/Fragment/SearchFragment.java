...
public class SearchFragment extends Fragment {
    ...
    private void searchUsers(final String s) {
        Query query = FirebaseDatabase.getInstance().getReference(new Constant().USERS).orderByChild("username")
                .startAt(s)
                .endAt(s + "\uf8ff");
    ...
    private void readUsers() {
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference(new Constant().USERS);
