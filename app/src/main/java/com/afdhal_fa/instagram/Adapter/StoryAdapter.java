            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (click) {
                    if (count > 0) {
                        ...
                        alertDialog.setButton(AlertDialog.BUTTON_NEGATIVE, "View stroty", new DialogInterface.OnClickListener() {
                            @Override
