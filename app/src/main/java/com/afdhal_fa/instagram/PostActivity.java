...
public class PostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storageReference = FirebaseStorage.getInstance().getReference(new Constant().POSTS);
...
//                        hashMap.put("publiser", FirebaseAuth.getInstance().getCurrentUser().getUid());
                        ...
                        Post post = new Post(postId, myUrl, description.getText().toString(), Objects.requireNonNull(FirebaseAuth.getInstance().getCurrentUser()).getUid());
